        ...
        <>
            <div className="flex flex-wrap">
                <div className="w-full">
                    <nav className="relative flex flex-wrap items-center justify-between px-2 py-2 navbar-expand-lg bg-indigo-900">
                        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                            ...
                            >
                                <ul className="navbar__items flex flex-col lg:flex-row list-none lg:ml-auto">
                                    ...
                                    <li className="nav-item">
                                        <a onClick={() => setShowLogin(true)} className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">
                                            <i className="fas fa-plus text-lg leading-lg text-white opacity-75">
                                            </i>

                                            <span className="ml-2">Modal</span>
                                        </a>
                                    </li>
                                    {user ?
                                        <>
