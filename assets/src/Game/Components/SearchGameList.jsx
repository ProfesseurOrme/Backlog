...
import image from "../../../img/placeholder-image.png";
            ...
            <div className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                <div className="p-4">
                    { game.platforms ? game.platforms.map(item => (
                        <span key={item.platform.id} className="inline-block mx-1 px-2 py-1 leading-none bg-purple-500 text-blueGray-100 rounded-full font-semibold uppercase tracking-wide text-xs">{item.platform.name}</span>
                    )) : "" }
                ...
                <div className="p-4 border-t border-b text-xs text-gray-700 text-center">
                    {
                        ...
                        <>
                            ...
                            <button className={(userGame.status === 2 ? "bg-orange-500 text-white" +
                                ...
                                " border border-solid border-orange-500 hover:bg-orange-500 hover:text-white active:bg-orange-500" ) + " font-bold uppercase text-xs px-4 py-2 rounded-full outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"} type="button">
                            ...
                            <button className={(userGame.status === 3 ? "bg-red-500 text-white active:bg-red-600" +
                                ...
                                " border-red-500 hover:bg-red-500 hover:text-white active:bg-red-500" ) + " font-bold uppercase text-xs px-4 py-2 rounded-full outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"} type="button">
                        ...
                        <button className="bg-purple-500 hover:bg-purple-900 text-white font-bold uppercase text-xs mx-1 px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
